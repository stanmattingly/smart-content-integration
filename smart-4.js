        ...
        if (!clusterId) {
            fetch(`https://6767-172-98-142-66.ngrok.io/api/app/content-clusters/`, {
                ...
                xpathComponents.forEach(xpathComponent => {
                    ...
                    fetch(`https://6767-172-98-142-66.ngrok.io/api/app/components/${xpathComponent.xpath}/get_smart_content/?smart_user_id=${localStorage.getItem('smart-user-id')}&cluster_uuid=${sessionStorage.getItem('smart-cluster-id')}`, {
                        method: 'get',
                        headers: {
                            'Authorization': `Token ${apiKey}`
                        }
