document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch(`https://a518-172-98-142-66.ngrok.io/auth/smart-add-tokens/${smartAddToken}/`, {
        method: "get",
        headers: {
        ...
        if (response.ok) {
                ...
                document.addEventListener('smartclick', event => {
                    ...
                    if (!isHTML(element.innerHTML) && element.innerHTML) {
                        if (!element.dataset.clicked) {
                            ...
                            fetch("https://a518-172-98-142-66.ngrok.io/api/app/components/", {
                                method: "post",
                                headers: {
                                    'Authorization': `Token ${apiKey}`,
            ...
            function logAction(element, eventType, component) {
                fetch(`https://a518-172-98-142-66.ngrok.io/api/app/analytics/`, {
                    method: 'post',
                    headers: {
                        'Authorization': `Token ${apiKey}`,
                        'Accept': 'application/json',
            ...
            function processSmartElements(xpathComponents) {
                ...
                if (!clusterId) {
                    fetch(`https://a518-172-98-142-66.ngrok.io/api/app/content-clusters/`, {
                        method: 'post',
                        headers: {
                            'Authorization': `Token ${apiKey}`,
                            'Accept': 'application/json',
                        ...
                        xpathComponents.forEach(xpathComponent => {
                            ...
                            fetch(`https://a518-172-98-142-66.ngrok.io/api/app/components/get_smart_content/?id=${encodeURIComponent(xpathComponent.xpath)}&smart_user_id=${localStorage.getItem('smart-user-id')}&cluster_uuid=${sessionStorage.getItem('smart-cluster-id')}`, {
                                method: 'get',
                                headers: {
                                    'Authorization': `Token ${apiKey}`
                                }
                    ...
                    xpathComponents.forEach(xpathComponent => {
                        const element = xpathComponent.element;
                        fetch(`https://a518-172-98-142-66.ngrok.io/api/app/components/get_smart_content/?id=${encodeURIComponent(xpathComponent.xpath)}&smart_user_id=${localStorage.getItem('smart-user-id')}&cluster_uuid=${clusterId}`, {
                            method: 'get',
                            headers: {
                                'Authorization': `Token ${apiKey}`
                            }
            ...
            function addClusterContents(clusterId, contents, userId) {
                fetch(`https://a518-172-98-142-66.ngrok.io/api/app/content-clusters/${clusterId}/`, {
                    method: 'patch',
                    headers: {
                        'Authorization': `Token ${apiKey}`,
                        'Accept': 'application/json',
            ...
            fetch('https://a518-172-98-142-66.ngrok.io/api/app/components/get_xpath_components/', {
                method: 'get',
                headers: {
                    'Authorization': `Token ${apiKey}`
                }
                ...
                buildComponents.then(() => {
                    if (!localStorage.getItem('smart-user-id')) {
                        fetch('https://a518-172-98-142-66.ngrok.io/api/app/analytic-users/', {
                            method: 'post',
                            headers: {
                                'Authorization': `Token ${apiKey}`
                            }
