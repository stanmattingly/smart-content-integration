            ...
            fetch('https://6767-172-98-142-66.ngrok.io/api/app/components/get_xpath_components/', {
                ...
                const buildComponents = new Promise((resolve, reject) => {
                    xpathComponents.forEach((xpathComponent, index, array) => {
                        ...
                        if (xpathComponent.element_class) {
                            classes.push(xpathComponent.element_class);
                        }

                        if (xpathComponent.element_id) {
                            ids.push(xpathComponent.element_id);
                        }
                ...
                mutations_list.forEach(mutation => {
                    mutation.addedNodes.forEach(addedNode => {
                        ...
                        if (xPaths.includes(xpath)) {
                            ...
                            classes.forEach(classText => {
                                const classNode = document.querySelector(`.${classText}`);
                                if (classNode) {
                                    xpath = createXPathFromElement(classNode);
                                    if (xPaths.includes(xpath) && !processedXPaths.includes(xpath)) {
                                        processSmartElements([{
                                            element: classNode,
                                            xpath: xpath,
                                            component: xPathComponentMapping[xpath],
